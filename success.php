                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        <h3>
                                            ID de pago: <b><?php echo $_GET['collection_id'] ?></b>
                                        </h3>
                                        <h4>
                                            Estado: <b><?php echo $_GET['collection_status'] ?></b>
                                        </h4>
                                        <h4>
                                            Referencia externa: <b><?php echo $_GET['external_reference'] ?></b>
                                        </h4>
                                        <h4>
                                            Método de pago: <b><?php echo $_GET['payment_type'] ?></b>
                                        </h4>
                                        <h4>
                                            Número de orden: <b><?php echo $_GET['merchant_order_id'] ?></b>
                                        </h4>                                       
collection_id=7716169125&
collection_status=approved&
external_reference=ruderr@yahoo.com&
payment_type=credit_card&
merchant_order_id=1615923694&
preference_id=469485398-3dad1a1d-8f00-4952-8fd5-ac3d939dbe7b&
site_id=MLA&
